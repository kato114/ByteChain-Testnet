...
func (k Keeper) OnAcknowledgementPacket(
	...
	_, err = k.ClaibytesForAction(ctx, sender, claimsRecord, types.ActionIBCTransfer, params)
	if err != nil {
		return err
	}
...
func (k Keeper) OnRecvPacket(
	...
	case senderRecordFound && !recipientRecordFound && isTriggerAmt:
		...
		claimedAmt, err = k.ClaibytesForAction(ctx, recipient, senderClaimsRecord, types.ActionIBCTransfer, params)
		...
		// NOTE: claim record is migrated to the recipient in ClaibytesForAction
		k.DeleteClaimsRecord(ctx, sender)
	...
	case !senderRecordFound && recipientRecordFound,
		...
		_, err = k.ClaibytesForAction(ctx, recipient, recipientClaimsRecord, types.ActionIBCTransfer, params)
	case !senderRecordFound && !recipientRecordFound:
