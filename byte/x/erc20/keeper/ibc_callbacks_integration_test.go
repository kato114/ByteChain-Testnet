...
var _ = Describe("Convert receiving IBC to Erc20", Ordered, func() {
	...
	Describe("enabled params and registered uosmo", func() {
		...
		It("should transfer and not convert gecko", func() {
			// Register 'gecko' coin in ERC-20 keeper to validate it is not converting the coins when receiving 'gecko' thru IBC
			...
			// 1. Send gecko from Evmos to Osmosis
			...
			// check ibc gecko coins balance on Osmosis
			...
			// 2. Send gecko IBC coins from Osmosis to Evmos
			...
			// check ibc gecko coins balance on Osmosis - should be zero
			...
			// check gecko balance after transfer - should be equal to initial balance
	...
	Describe("Performing claims with registered coin", func() {
		...
		It("it should perform the claim and convert the received tokens", func() {
			...
			// should trigger claims logic and send gecko coins from claims to receiver
