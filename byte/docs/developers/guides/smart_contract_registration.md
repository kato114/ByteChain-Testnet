...
geckod tx revenue register $CONTRACT $NONCE $WITHDRAWER \
...
```bash
# Check revenues
geckod q revenue contract $CONTRACT
```
...
geckod tx revenue update $CONTRACT $WITHDRAWER \
...
geckod tx revenue cancel $CONTRACT \
--gas=700000 --gas-prices=10000pose \
--from=mm
```
