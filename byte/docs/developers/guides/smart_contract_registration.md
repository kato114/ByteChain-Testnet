...
byted tx revenue register $CONTRACT $NONCE $WITHDRAWER \
...
```bash
# Check revenues
byted q revenue contract $CONTRACT
```
...
byted tx revenue update $CONTRACT $WITHDRAWER \
...
byted tx revenue cancel $CONTRACT \
--gas=700000 --gas-prices=10000pose \
--from=mm
```
