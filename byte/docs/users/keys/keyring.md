...
MY_VALIDATOR_ADDRESS=$(byted keys show dev0 -a)
```
...
yes $KEYPASSWD | byted keys add me
yes $KEYPASSWD | byted keys show me
# start byted with keyring-backend flag
byted --keyring-backend=file start
```
