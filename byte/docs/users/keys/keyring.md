...
MY_VALIDATOR_ADDRESS=$(geckod keys show dev0 -a)
```
...
yes $KEYPASSWD | geckod keys add me
yes $KEYPASSWD | geckod keys show me
# start geckod with keyring-backend flag
geckod --keyring-backend=file start
```
